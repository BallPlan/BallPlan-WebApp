...
import { LifeBuoy, Mail, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
import logoIcon from '../../assets/logo-icon.png';
import { useAdminAuth } from '../../admin/context/AdminAuthContext';

// Same auth backend as /admin (AdminAuthContext already accepts both owner
// and support roles) — this file only exists to give /support its own
// branded login screen instead of showing "BallPlan Admin".
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-3 flex items-center gap-1.5 text-brand">
            <LifeBuoy size={16} />
            <span className="text-xs font-bold uppercase tracking-wider">Support Access</span>
          </div>
          <h1 className="mt-1 text-2xl font-extrabold text-ink">BallPlan Support</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-7 space-y-4">
          ...
          <p className="text-center text-xs text-ink/40">
            Support accounts are created by a BallPlan admin — contact them if you don't have one.
          </p>
        </form>
      </motion.div>
    </div>
