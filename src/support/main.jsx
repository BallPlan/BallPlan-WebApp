...
// (support.html sets window.__ballplanPortal, which admin/lib/
// supabaseClient.js reads) and allowedRoles restricted to 'support' only —
// an owner account cannot sign in here, matching /admin restricting itself
// to 'owner' only.
